...
2. Complete and activate the dormant read-only provider-position boundary.
   ...
   trusted-assessment runtime binding, persistence admission, approved policy
   ...
   identity. It performs no ambient I/O, is not wired into the runtime
   composition, and no concrete durable-anchor reader exists.
   Construction
