...
2. Complete and activate the dormant read-only provider-position boundary.
   ...
   preserves migration `0028`'s worker suspension. There is no evidence
   writer/producer, populated evidence claim, runtime registration or activation,
   deployment, or live evidence. Construction
