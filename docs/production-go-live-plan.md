...
runtime input, and all 395 current lowercase TypeScript/TSX sources not excluded
...
depth. The current source total is 6,265,963 bytes, and preflight commit
`667b112` pins SHA-256
...
revision with zero retained history. It does not run the production-principal
verifier or seed prepare, bind, broadcast, or reconciliation rows. No
application repository, API/worker composition, runtime grant, scheduled
reconciler, provider write binding, deployed evidence, or mainnet-write
authority exists; `0033` is a dormant database substrate only.
...
| Mainnet writes            | A dormant mainnet action domain/lifecycle and owner-only migration `0033` intent store exist, but no application repository/runtime, provider write manifest or action binding, transaction construction, route, runtime grant, or write approval exists                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Every additional write gate in `mainnet-rollout.md` and the per-provider transaction evidence above passes for an exact allowlisted action                                                                                                                                                                                    |
...
`667b112` pins the reviewed whole-API runtime snapshot at 395 files and
6,265,963 bytes with
...
The separate `0033` integration suite has three cases for the test-schema
migration chain through `0033` plus its isolated-schema verifier, rolled-back
reconciliation-index/normalized-check tamper rejection, and SQLSTATE `22023`
rejection of a null expected revision with zero history. It does not run the
production-principal verifier or seed or exercise prepare, bind, broadcast, or
reconcile rows and must not be represented as runtime or live transaction
evidence.
