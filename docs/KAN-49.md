...
| Key and secret inventory                               | Fifteen metadata-only credential/key classes include application, bootstrap, wallet-lab, three purpose-distinct wallet-registration keys, ledger, Jira, and workflow authority with consumer, injection, storage, rotation, owner, and evidence | Ready for review; KAN-50 custody and rotation remain external gates                |
| Retention considerations                               | Seventeen data assets and a per-store retention/deletion matrix distinguish validity, retention, and unresolved policy                                                                                                                          | Ready for review; governance decisions remain open                                 |
