...
const NETWORK_SCHEMA: SchemaObject = {
  ...
  properties: {
    id: {
      type: 'string',
      enum: ['eip155:1', 'eip155:56', 'eip155:8453', 'solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp'],
    },
    name: { type: 'string', enum: ['Ethereum', 'BNB Smart Chain', 'Base', 'Solana'] },
  },
};
...
const PLATFORM_SCHEMA: SchemaObject = {
  ...
  properties: {
    ...
    networks: { type: 'array', minItems: 1, maxItems: 4, uniqueItems: true, items: NETWORK_SCHEMA },
