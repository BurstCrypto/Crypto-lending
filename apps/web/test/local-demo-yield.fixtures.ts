...
export const BALANCED_PREVIEW: LocalDemoAllocationPreview = Object.freeze({
  ...
  yieldProjection: Object.freeze({
    ...
    projectedAnnualYieldUsdMinor: '35827',
    projectedAnnualNetGrowthUsdMinor: '28127',
    breakEven: Object.freeze({ status: 'AVAILABLE', firstNetPositiveDay: 79 }),
  }),
...
export const MORE_LIQUID_PREVIEW: LocalDemoAllocationPreview = Object.freeze({
  ...
  allocations: Object.freeze(
    BALANCED_PREVIEW.allocations.map((allocation, index) =>
      Object.freeze({
        ...
        amountUsdMinor: ['660000', '146740', '146630', '146630'][index]!,
      }),
    ),
  ),
  deductions: Object.freeze([
  ...
  yieldProjection: Object.freeze({
    ...
    projectedAnnualYieldUsdMinor: '20487',
    projectedAnnualNetGrowthUsdMinor: '16087',
    breakEven: Object.freeze({ status: 'AVAILABLE', firstNetPositiveDay: 79 }),
  }),
});
