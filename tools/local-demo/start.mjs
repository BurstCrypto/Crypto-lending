...
process.stdout.write(
  [
    ...
    'One explicitly selected Wallet Standard wallet confirms, signs, and broadcasts the exact message; the API never signs, broadcasts, or requests an airdrop.',
    ...
    'Completion requires finalized exact-message and position verification. The proof position remains deposited because no withdrawal is included.',
